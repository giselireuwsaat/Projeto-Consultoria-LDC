        ...
        <section class="resultados">
            <div class="row">
                <div class="col-md-3 resultado">
                    <h2><?php echo $campos_service['workshop-resultado1'];?></h2>
                    
                    <img src="<?php echo $campos_service['workshop-img1'];?>"/>

                    
                    <!-- <img src="http://localhost/consultoria_LDC/wp-content/uploads/2020/08/20200302_205304-scaled.jpg"> -->
